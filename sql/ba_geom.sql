...
INSERT INTO subway_stations(coordinates, station, line) SELECT ST_POINT(t.long, t.lat), t.station, t.line FROM temp_subway_stations t;
DROP TABLE IF EXISTS temp_subway_stations;
...
INSERT INTO police_stations(name, coordinates, neighborhood) SELECT t.nombre, ST_POINT(t.long, t.lat), t.barrio  FROM temp_police_stations t;
